...
export class RemoveUniqueIndexAtPitcherPaticipation1746448414399 implements MigrationInterface {
    name = 'RemoveUniqueIndexAtPitcherPaticipation1746448414399'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`umpire_email_codes\` DROP COLUMN \`code_hash\``);
        await queryRunner.query(`ALTER TABLE \`umpire_email_codes\` ADD \`code_hash\` varchar(255) NOT NULL`);
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_3e29bbbe09c8647b79a849a20b\` ON \`pitcher_game_participations\` (\`game_id\`, \`player_id\`)`);
