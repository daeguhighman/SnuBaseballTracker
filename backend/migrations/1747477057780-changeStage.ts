...
export class ChangeStage1747477057780 implements MigrationInterface {
    name = 'ChangeStage1747477057780'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`games\` ADD \`bracket_position\` enum ('QF_1', 'QF_2', 'QF_3', 'QF_4', 'SF_1', 'SF_2', 'THIRD_PLACE', 'F') NULL`);
        await queryRunner.query(`ALTER TABLE \`games\` CHANGE \`home_team_id\` \`home_team_id\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`games\` CHANGE \`away_team_id\` \`away_team_id\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`games\` CHANGE \`start_time\` \`start_time\` timestamp NULL`);
        await queryRunner.query(`ALTER TABLE \`games\` CHANGE \`stage\` \`stage\` enum ('LEAGUE', 'QUARTER_FINAL', 'SEMI_FINAL', 'THIRD_PLACE', 'FINAL') NOT NULL DEFAULT 'LEAGUE'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`umpire_email_codes\` DROP COLUMN \`code_hash\``);
        await queryRunner.query(`ALTER TABLE \`umpire_email_codes\` ADD \`code_hash\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`games\` CHANGE \`stage\` \`stage\` enum ('LEAGUE', 'QUARTERFINAL', 'SEMIFINAL', 'FINAL') NOT NULL DEFAULT 'LEAGUE'`);
        await queryRunner.query(`ALTER TABLE \`games\` CHANGE \`start_time\` \`start_time\` timestamp NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`games\` CHANGE \`away_team_id\` \`away_team_id\` int NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`games\` CHANGE \`home_team_id\` \`home_team_id\` int NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`games\` DROP COLUMN \`bracket_position\``);
