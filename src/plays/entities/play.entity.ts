...
export class Play {
  ...
  @ManyToOne(() => GameInningStat, (g) => g.plays, { onDelete: 'CASCADE' })
  ...
  @ManyToOne(() => BatterGameParticipation, (b) => b.gamePlays, {
    eager: false,
  })
  @JoinColumn({ name: 'batter_gp_id' })
  ...
  @ManyToOne(() => PitcherGameParticipation, (p) => p.gamePlays, {
    eager: false,
  })
  @JoinColumn({ name: 'pitcher_gp_id' })
