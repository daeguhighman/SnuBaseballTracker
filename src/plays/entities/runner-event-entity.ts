...
export class RunnerEvent {
  ...
  @ManyToOne(() => Game, (g) => g.runnerEvents, { onDelete: 'CASCADE' })
  ...
  // /* ---------- 기타 ---------- */
  // /** 아웃이 직접 발생했으면 1, 복합·요약 기록이 필요 없으면 0 */
  // @Column({ type: 'tinyint', unsigned: true, default: 0 })
  // outsRecorded: number;

  // @Column({ name: 'responsible_pitcher_gp_id', nullable: true })
  // responsiblePitcherGpId?: number;

  // @ManyToOne(() => PitcherGameParticipation, { eager: false, nullable: true })
