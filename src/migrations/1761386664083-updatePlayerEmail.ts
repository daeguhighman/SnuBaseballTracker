...
export class UpdatePlayerEmail1761386664083 implements MigrationInterface {
    name = 'UpdatePlayerEmail1761386664083'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`players\` ADD \`email\` varchar(100) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`sessions\` ADD CONSTRAINT \`FK_085d540d9f418cfbdc7bd55bb19\` FOREIGN KEY (\`user_id\`) REFERENCES \`snubaseballtracker\`.\`users\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
