...
export class AddTourament1746538295794 implements MigrationInterface {
    name = 'AddTourament1746538295794'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`games\` ADD \`stage\` enum ('LEAGUE', 'QUARTERFINAL', 'SEMIFINAL', 'FINAL') NOT NULL DEFAULT 'LEAGUE'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`umpire_email_codes\` DROP COLUMN \`code_hash\``);
        await queryRunner.query(`ALTER TABLE \`umpire_email_codes\` ADD \`code_hash\` varchar(255) NOT NULL`);
        await queryRunner.query(`ALTER TABLE \`games\` DROP COLUMN \`stage\``);
