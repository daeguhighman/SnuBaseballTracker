...
export const OutZoneLabel = styled.span`
  display: none;
`;

const scoreToastAnim = keyframes`
...
export const ScoreToast = styled.div`
  position: absolute;
  left: 50%;
  bottom: 12%;
  ...
  pointer-events: none;
  z-index: 50;
  animation: ${scoreToastAnim} 1500ms ease-out forwards;
`;
